...
function buildHero() {
  ...
  heroImages = SCHOOL_CONFIG.heroImages.fallback;
  if (SCHOOL_CONFIG.heroImages.source === "hosted" && SCHOOL_CONFIG.heroImages.hosted.length) {
    heroImages = SCHOOL_CONFIG.heroImages.hosted.map(h => ({ url: h.path, caption: h.caption }));
  }
